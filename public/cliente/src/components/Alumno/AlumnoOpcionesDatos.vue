<template>
  ...
  <section class="src-components-alumno-opciones-datos">
...
<script lang="js">
  ...
  export default  {
    name: 'src-components-alumno-opciones-datos',
    props: [],
    components: {
      Header
    },
    ...
    methods: {
      ...
      enviar() {
        ...
        setTimeout(() => {
          this.axios.post(urlAlumnos + 'agregarsolicitud/', solicitud,{
...
<style scoped lang="css">
  .src-components-alumno-opciones-datos {
