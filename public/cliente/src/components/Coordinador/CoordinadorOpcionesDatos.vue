<template>
  ...
  <section class="src-components-coordinador-opciones-datos">
...
<script lang="js">
  ...
  export default  {
    name: 'src-components-coordinador-opciones-datos',
    props: [],
    components: {
      Header
    },
    ...
    methods: {
      ...
      enviar() {
        ...
        setTimeout(() => {
          this.axios.put(urlCoordinadores, this.formData)
          .then(res => {
            if(res.data.error){
              this.errorEnvio = true
              this.estiloMensajeEnviado = "alert alert-danger my-1"
              this.mensajeEnvio = "Error al modificar el Coordinador"
            }
            else {
              this.estiloMensajeEnviado = "alert alert-success my-1"
              this.mensajeEnvio = "Coordinador modificado satisfactoriamente"
              this.$store.dispatch('actualizarUsuarioCoordinador', res.data) 
...
<style scoped lang="css">
  .src-components-coordinador-opciones-datos {
